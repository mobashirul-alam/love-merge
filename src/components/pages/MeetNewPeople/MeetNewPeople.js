  ...
  return (
    <>
      <section className={meetNewPeople.howItWorkSection}>
        ...
        />
        <img
          className={meetNewPeople.shape2}
          src={birdShape}
          alt="Not Available"
        />
            ...
            <div className="w-[50%] mx-auto">
              <div className="content">
                <div className="mb-[40px] text-center">
                  <h6 className="text-[#ff317b] mb-[30px] text-[24px] font-bold">
                    Meet Your Perfect Date Partner Today!
                  </h6>
                  <h2 className="text-[#ff317b] text-[25px] font-medium mb-[11px]">
                    How Does It Work?
                  </h2>
                  <p className="text-[#3b368c] text-[20px] mb-[16px]">
                    You’re just 3 steps away from a great Match
                  </p>
                </div>
              </div>
            </div>
